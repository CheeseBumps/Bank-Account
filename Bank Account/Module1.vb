Module Module1
    ...
    Sub Main()
        ...
        If age >= 18 Then
            ...
            Do
                Console.WriteLine("Please deposit a minimum of  BTC 20,000 to start your account.")
            ...
            Do
                ...
                If chance > 0 Then
                    ...
                    Console.WriteLine("You have BTC " & total & " in your account.")
                    ...
                    If reply = ("deposit") Then
                        ...
                        total = total + deposit
                        Console.WriteLine("You have " & "BTC " & total & "  remaining in your account.")
                ...
                End If
            Loop Until reply = "log out" Or chance = 0
